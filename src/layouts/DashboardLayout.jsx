  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content">
        {/* Navbar */}
        <nav className="navbar w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between w-full">
            ...
            <div>
              <div className="flex items-center gap-2 bg-gray-200/50 border border-gray-200 dark:border-gray-800 py-2 px-3 rounded-lg">
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        ></label>
        <div className="flex min-h-full flex-col items-start bg-white dark:bg-gray-900 border-e border-gray-200 dark:border-gray-800 is-drawer-close:w-14 is-drawer-open:w-64">
